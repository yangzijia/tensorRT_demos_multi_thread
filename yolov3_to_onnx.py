...
class DarkNetParser(object):
    ...
    def _next_layer(self, remainder):
        ...
        if type(remainder).__name__ != "str":
            remainder = str(remainder, encoding="utf8").split('[', 1)
        else:
...
def main(weights_file_path, output_file_path, cfg_file_path):
...
if __name__ == '__main__':
    ...
    input_weights_path = "classes3/classes3.weights"
    output_file_path = 'classes3/classes3.onnx'
    cfg_file_path = "classes3/classes3.cfg"

    main(input_weights_path, output_file_path, cfg_file_path)
